...
router.get('/:idSTOW/similarity/cosinus', (req, res, next) => {
...
router.get('/:idSTOW/similarity/answer', (req, res, next) => {
...
router.get('/:idSTOW/similarity/question', (req, res, next) => {
...
router.get('/:idSTOW/proficiency', (req, res, next) => {
