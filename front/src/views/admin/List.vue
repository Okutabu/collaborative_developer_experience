        ...
        <template v-if="users">
          ...
          >
            <div class="container-user-enlisted">
              <td
                v-if="user.name.toLowerCase().includes(inputName.toLowerCase()) && user.surname.toLowerCase().includes(input.toLowerCase()) && (user.topTag.toLowerCase().includes(inputTag.toLowerCase()))"
                class="user-enlisted"
              >
                <img
                  :src="user.avatar"
